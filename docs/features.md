...
| O14 | Optionale Ebene mit anderen Schiffen (AIS), antippbar für Kurs, Geschwindigkeit und Zielhafen. Recherchiert in 0.21.1: frei zugängliche Live-Quellen verlangen entweder einen Schlüssel (also eine Server-Komponente) oder decken das Revier nicht ab. Wege und Entwurf stehen in `architecture.md` | Grundsatzentscheidung |
| --- | --- | --- |
